...
'
    ...
    Set grapevine.model.Game = New GameClass
    Set OutputEngine = New OutputEngineClass
    
    Set PlayerList = grapevine.model.Game.PlayerList
    Set CharacterList = grapevine.model.Game.CharacterList
    Set ItemList = grapevine.model.Game.ItemList
    Set RoteList = grapevine.model.Game.RoteList
    Set LocationList = grapevine.model.Game.LocationList
    Set ActionList = grapevine.model.Game.APREngine.ActionList
    Set PlotList = grapevine.model.Game.APREngine.PlotList
    Set RumorList = grapevine.model.Game.APREngine.RumorList
    Set AllRumorLists = grapevine.model.Game.AllRumorLists
    Set InfluenceUseList = grapevine.model.Game.InfluenceUseList
...
'
    ...
    Set grapevine.model.Game = Nothing
...
'
    ...
    Do
        ...
        If Not Found Then
            ...
            If Not Found And InStr(grapevine.model.Game.GameFile, "\") > 0 Then
                TryFile = Left(grapevine.model.Game.GameFile, InStrRev(grapevine.model.Game.GameFile, "\")) & BaseFile
                Found = (Dir(TryFile) <> "")
            End If
...
'
    ...
    If HideSTFromFile Then StrVal = grapevine.model.Game.STFilter(StrVal)
