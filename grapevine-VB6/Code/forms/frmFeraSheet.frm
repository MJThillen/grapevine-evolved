...
Begin VB.Form frmFeraSheet 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Fera Character"
   ClientHeight    =   6165
   ClientLeft      =   210
   ClientTop       =   405
   ClientWidth     =   9060
   Icon            =   "frmFeraSheet.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Frame fraTab 
      ...
      Begin VB.ListBox lstTraits 
         Height          =   2010
         Index           =   11
         ItemData        =   "frmFeraSheet.frx":0B14
         Left            =   4440
         List            =   "frmFeraSheet.frx":0B16
         TabIndex        =   86
         Tag             =   "Wisdom"
         Top             =   480
         Width           =   2055
      ...
      Begin VB.ListBox lstTraits 
         Height          =   2010
         Index           =   10
         ItemData        =   "frmFeraSheet.frx":0B18
         Left            =   2280
         List            =   "frmFeraSheet.frx":0B1A
         TabIndex        =   84
         Tag             =   "Glory"
         Top             =   480
         Width           =   2055
      ...
      Begin VB.ListBox lstTraits 
         Height          =   2010
         Index           =   9
         ItemData        =   "frmFeraSheet.frx":0B1C
         Left            =   120
         List            =   "frmFeraSheet.frx":0B1E
         TabIndex        =   82
         Tag             =   "Honor"
         Top             =   480
         Width           =   2055
   ...
   Begin VB.Frame fraTab 
      ...
      Begin VB.ListBox lstTraits 
         Height          =   1035
         Index           =   19
         ItemData        =   "frmFeraSheet.frx":0B20
         Left            =   120
         List            =   "frmFeraSheet.frx":0B22
         TabIndex        =   108
         Tag             =   "?LO"
         Top             =   480
         Width           =   3135
      ...
      Begin VB.ListBox lstTraits 
         Height          =   2400
         Index           =   18
         ItemData        =   "frmFeraSheet.frx":0B24
         Left            =   120
         List            =   "frmFeraSheet.frx":0B26
         TabIndex        =   112
         Tag             =   "?EQ"
         Top             =   2160
         Width           =   3135
   ...
   Begin VB.Frame fraTab 
      ...
      Begin VB.ListBox lstTraits 
         Height          =   2400
         Index           =   15
         ItemData        =   "frmFeraSheet.frx":0B28
         Left            =   120
         List            =   "frmFeraSheet.frx":0B2A
         TabIndex        =   77
         Tag             =   "Gifts"
         Top             =   2160
         Width           =   3135
      ...
      Begin VB.ListBox lstTraits 
         Height          =   2400
         Index           =   16
         ItemData        =   "frmFeraSheet.frx":0B2C
         Left            =   3360
         List            =   "frmFeraSheet.frx":0B2E
         TabIndex        =   79
         Tag             =   "Rites"
         Top             =   2160
         Width           =   3135
      ...
      Begin VB.ListBox lstTraits 
         Height          =   1035
         Index           =   12
         ItemData        =   "frmFeraSheet.frx":0B30
         Left            =   3360
         List            =   "frmFeraSheet.frx":0B32
         TabIndex        =   75
         Tag             =   "Health Levels"
         Top             =   480
         Width           =   3135
      ...
      Begin VB.ListBox lstTraits 
         Height          =   1035
         Index           =   17
         ItemData        =   "frmFeraSheet.frx":0B34
         Left            =   120
         List            =   "frmFeraSheet.frx":0B36
         TabIndex        =   73
         Tag             =   "Features"
         Top             =   480
         Width           =   3135
   ...
   Begin VB.Frame fraTab 
      ...
      Begin VB.ListBox lstTraits 
         Height          =   2010
         Index           =   6
         ItemData        =   "frmFeraSheet.frx":0B38
         Left            =   120
         List            =   "frmFeraSheet.frx":0B3A
         TabIndex        =   62
         Tag             =   "Abilities"
         Top             =   480
         Width           =   2055
      ...
      Begin VB.ListBox lstTraits 
         Height          =   2010
         Index           =   7
         ItemData        =   "frmFeraSheet.frx":0B3C
         Left            =   4440
         List            =   "frmFeraSheet.frx":0B3E
         TabIndex        =   66
         Tag             =   "Influences"
         Top             =   480
         Width           =   2055
      ...
      Begin VB.ListBox lstTraits 
         Height          =   1425
         Index           =   13
         ItemData        =   "frmFeraSheet.frx":0B40
         Left            =   120
         List            =   "frmFeraSheet.frx":0B42
         TabIndex        =   68
         Tag             =   "Merits"
         Top             =   3120
         Width           =   3135
      ...
      Begin VB.ListBox lstTraits 
         Height          =   1425
         Index           =   14
         ItemData        =   "frmFeraSheet.frx":0B44
         Left            =   3360
         List            =   "frmFeraSheet.frx":0B46
         TabIndex        =   70
         Tag             =   "Flaws"
         Top             =   3120
         Width           =   3135
      ...
      Begin VB.ListBox lstTraits 
         Height          =   2010
         Index           =   8
         ItemData        =   "frmFeraSheet.frx":0B48
         Left            =   2280
         List            =   "frmFeraSheet.frx":0B4A
         TabIndex        =   64
         Tag             =   "Backgrounds"
         Top             =   480
         Width           =   2055
   ...
   Begin VB.Frame fraTab 
      ...
      Begin VB.ListBox lstTraits 
         Height          =   2010
         Index           =   0
         ItemData        =   "frmFeraSheet.frx":0B4C
         Left            =   120
         List            =   "frmFeraSheet.frx":0B4E
         TabIndex        =   49
         Tag             =   "Physical"
         Top             =   480
         Width           =   2055
      ...
      Begin VB.ListBox lstTraits 
         Height          =   2010
         Index           =   1
         ItemData        =   "frmFeraSheet.frx":0B50
         Left            =   2280
         List            =   "frmFeraSheet.frx":0B52
         TabIndex        =   51
         Tag             =   "Social"
         Top             =   480
         Width           =   2055
      ...
      Begin VB.ListBox lstTraits 
         Height          =   2010
         Index           =   2
         ItemData        =   "frmFeraSheet.frx":0B54
         Left            =   4440
         List            =   "frmFeraSheet.frx":0B56
         TabIndex        =   53
         Tag             =   "Mental"
         Top             =   480
         Width           =   2055
      ...
      Begin VB.ListBox lstTraits 
         Height          =   1425
         Index           =   3
         ItemData        =   "frmFeraSheet.frx":0B58
         Left            =   120
         List            =   "frmFeraSheet.frx":0B5A
         TabIndex        =   55
      ...
      Begin VB.ListBox lstTraits 
         Height          =   1425
         Index           =   4
         ItemData        =   "frmFeraSheet.frx":0B5C
         Left            =   2280
         List            =   "frmFeraSheet.frx":0B5E
         TabIndex        =   57
         Tag             =   "Social, Negative"
         Top             =   3120
         Width           =   2055
      ...
      Begin VB.ListBox lstTraits 
         Height          =   1425
         Index           =   5
         ItemData        =   "frmFeraSheet.frx":0B60
         Left            =   4440
         List            =   "frmFeraSheet.frx":0B62
         TabIndex        =   59
         Tag             =   "Mental, Negative"
         Top             =   3120
         Width           =   2055
   ...
   Begin VB.ListBox lstMenu 
      Height          =   2010
      ItemData        =   "frmFeraSheet.frx":0B64
      Left            =   120
      List            =   "frmFeraSheet.frx":0B66
      TabIndex        =   2
      Top             =   1200
      Width           =   1695
   End
   ...
   End
End
Attribute VB_Name = "frmFeraSheet"
...
Private Fera As FeraClass                   'The Fera character
...
Public Sub ShowFera(Character As FeraClass)
'
' Name:         ShowFera
' Description:  Show and initialize a new instance of the form.
' Arguments:    The FeraClass whose data the form modifies.
'
    ...
    txtUserField(xiName) = Fera.Name
    Me.Caption = Fera.Name
    
    lblField(fiFera) = Fera.Fera
    lblField(fiAuspice) = Fera.Auspice
    lblField(fiBreed) = Fera.Breed
    lblField(fiPosition) = Fera.Position
    lblField(fiNature) = Fera.Nature
    lblField(fiDemeanor) = Fera.Demeanor
    lblField(fiRank) = Fera.Rank
    lblField(fiTotem) = Fera.Totem
    lblField(fiStatus) = Fera.Status
    lblField(fiPlayer) = Fera.Player
    lblField(fiNarrator) = Fera.Narrator
        
    lblTraitMax(tiPhysical) = "Max " & CStr(Fera.PhysicalMax)
    lblTraitMax(tiSocial) = "Max " & CStr(Fera.SocialMax)
    lblTraitMax(tiMental) = "Max " & CStr(Fera.MentalMax)
    
    txtUserField(xiID) = Fera.ID
    txtUserField(xiPack) = Fera.Pack
    txtUserField(xiStartDate) = Format(Fera.StartDate, "mmmm d, yyyy")
    
    txtMemo(miBiography) = Fera.Biography
    txtMemo(miNotes) = Fera.Notes

    Call ChangeTemper(piRage, 0)
    Call ChangeTemper(piGnosis, 0)
    Call ChangeTemper(piWillpower, 0)
    
    CharSheetEngine.RefreshTraitList lstTraits(tiPhysical), Fera.PhysicalList
    CharSheetEngine.RefreshTraitList lstTraits(tiSocial), Fera.SocialList
    CharSheetEngine.RefreshTraitList lstTraits(tiMental), Fera.MentalList
    CharSheetEngine.RefreshTraitList lstTraits(tiPhysicalNeg), Fera.PhysicalNegList
    CharSheetEngine.RefreshTraitList lstTraits(tiSocialNeg), Fera.SocialNegList
    CharSheetEngine.RefreshTraitList lstTraits(tiMentalNeg), Fera.MentalNegList
    CharSheetEngine.RefreshTraitList lstTraits(tiAbilities), Fera.AbilityList
    CharSheetEngine.RefreshTraitList lstTraits(tiInfluences), Fera.InfluenceList
    CharSheetEngine.RefreshTraitList lstTraits(tiBackgrounds), Fera.BackgroundList
    CharSheetEngine.RefreshTraitList lstTraits(tiHonor), Fera.HonorList
    CharSheetEngine.RefreshTraitList lstTraits(tiGlory), Fera.GloryList
    CharSheetEngine.RefreshTraitList lstTraits(tiWisdom), Fera.WisdomList
    CharSheetEngine.RefreshTraitList lstTraits(tiHealth), Fera.HealthList
    
    CharSheetEngine.RefreshTraitList lstTraits(tiMerits), Fera.MeritList
    CharSheetEngine.RefreshTraitList lstTraits(tiFlaws), Fera.FlawList
    CharSheetEngine.RefreshTraitList lstTraits(tiGifts), Fera.GiftList
    CharSheetEngine.RefreshTraitList lstTraits(tiRites), Fera.RiteList
    CharSheetEngine.RefreshTraitList lstTraits(tiFeatures), Fera.FeatureList
    CharSheetEngine.RefreshTraitList lstTraits(tiEquipment), Fera.EquipmentList
    CharSheetEngine.RefreshTraitList lstTraits(tiLocations), Fera.HangoutList
    
    updNumber(niNotoriety).Value = Fera.Notoriety
    
    txtPerm(diHonor).Text = CStr(Fera.Honor)
    txtTemp(diHonor).Text = CStr(Fera.TempHonor)
    txtPerm(diGlory).Text = CStr(Fera.Glory)
    txtTemp(diGlory).Text = CStr(Fera.TempGlory)
    txtPerm(diWisdom).Text = CStr(Fera.Wisdom)
    txtTemp(diWisdom).Text = CStr(Fera.TempWisdom)
    
    lblModified.Caption = Format(Fera.LastModified, "mmmm d, yyyy")
    chkNPC.Value = IIf(Fera.IsNPC, vbChecked, vbUnchecked)
...
'
    With OutputEngine
        ...
        .SelectSet(osCharacters).Add Fera.Name
        .GameDate = 0
    End With
...
'
    ...
    If Not Populating Then
        Fera.IsNPC = (chkNPC.Value = vbChecked)
...
'
    ...
    If lstMenu.ListIndex <> -1 Then
        ...
        If CharSheetEngine.TargetType = ttXPHistory Then
            If CharSheetEngine.AddXPEntry(lvwHistory, Fera.Experience) Then
                RefreshXP
                SetDataChanged
                lvwHistory.SetFocus
            End If
...
'
    frmCalculator.ShowCalculator Fera
...
'
    ...
    If CharSheetEngine.TargetType = ttXPHistory Then
        If CharSheetEngine.EditXPEntry(lvwHistory, Fera.Experience) Then
            RefreshXP
            SetDataChanged
            lvwHistory.SetFocus
        End If
...
'
    ...
    If CharSheetEngine.TargetType = ttXPHistory Then
        If CharSheetEngine.RemoveXPEntry(lvwHistory, Fera.Experience) Then
            RefreshXP
            SetDataChanged
            lvwHistory.SetFocus
        End If
...
'
    ...
    If TargetIndex = tiPhysical Or Game.LinkTraitMaxes Then
        Fera.PhysicalMax = Fera.PhysicalMax + IIf(Index = 1, 1, -1)
        lblTraitMax(tiPhysical).Caption = "Max " & Fera.PhysicalMax
    End If
    
    If TargetIndex = tiSocial Or Game.LinkTraitMaxes Then
        Fera.SocialMax = Fera.SocialMax + IIf(Index = 1, 1, -1)
        lblTraitMax(tiSocial).Caption = "Max " & Fera.SocialMax
    End If
    
    If TargetIndex = tiMental Or Game.LinkTraitMaxes Then
        Fera.MentalMax = Fera.MentalMax + IIf(Index = 1, 1, -1)
        lblTraitMax(tiMental).Caption = "Max " & Fera.MentalMax
    End If
...
'
    ...
    lblModified.Caption = Format(Fera.LastModified, "mmmm d, yyyy")
    lblShowXP = " " & CStr(Fera.Experience.Unspent) & _
            " / " & CStr(Fera.Experience.Earned)

    CharSheetEngine.RefreshTraitList lstTraits(tiEquipment), Fera.EquipmentList
    CharSheetEngine.RefreshTraitList lstTraits(tiLocations), Fera.HangoutList
    lblField(fiPlayer).Caption = Fera.Player
    lblField(fiNarrator).Caption = Fera.Narrator
...
'               when ShowFera is the means of loading the form.  Initializes the
'               MenuStack linked list and the Fera Menus.
'

    If Fera Is Nothing Then
        MsgBox "Character sheet loaded improperly!"
    Else
    
        Set CharSheetEngine = New CharacterSheetEngineClass
    
        CharSheetEngine.RegisterSheet "Fera", lstMenu, lblMenuItem, lblMenuTitle
    
        CharSheetEngine.RegisterTraitList tiPhysical, Fera.PhysicalList
        CharSheetEngine.RegisterTraitList tiSocial, Fera.SocialList
        CharSheetEngine.RegisterTraitList tiMental, Fera.MentalList
        CharSheetEngine.RegisterTraitList tiPhysicalNeg, Fera.PhysicalNegList
        CharSheetEngine.RegisterTraitList tiSocialNeg, Fera.SocialNegList
        CharSheetEngine.RegisterTraitList tiMentalNeg, Fera.MentalNegList
        CharSheetEngine.RegisterTraitList tiAbilities, Fera.AbilityList
        CharSheetEngine.RegisterTraitList tiInfluences, Fera.InfluenceList
        CharSheetEngine.RegisterTraitList tiBackgrounds, Fera.BackgroundList
        CharSheetEngine.RegisterTraitList tiHonor, Fera.HonorList
        CharSheetEngine.RegisterTraitList tiGlory, Fera.GloryList
        CharSheetEngine.RegisterTraitList tiWisdom, Fera.WisdomList
        CharSheetEngine.RegisterTraitList tiHealth, Fera.HealthList
    
        CharSheetEngine.RegisterTraitList tiMerits, Fera.MeritList
        CharSheetEngine.RegisterTraitList tiFlaws, Fera.FlawList
        CharSheetEngine.RegisterTraitList tiGifts, Fera.GiftList
        CharSheetEngine.RegisterTraitList tiRites, Fera.RiteList
        CharSheetEngine.RegisterTraitList tiFeatures, Fera.FeatureList
        CharSheetEngine.RegisterTraitList tiEquipment, Fera.EquipmentList
        CharSheetEngine.RegisterTraitList tiLocations, Fera.HangoutList
...
'
    ...
    If Not lblTemperFloat.Visible Or Not lblTemperFloat.Tag = CStr(Index) Then
        ...
        Select Case Index
            Case piWillpower:   lblTemperFloat = " " & CStr(Fera.TempWillpower) & " "
            Case piRage:        lblTemperFloat = " " & CStr(Fera.TempRage) & " "
            Case piGnosis:      lblTemperFloat = " " & CStr(Fera.TempGnosis) & " "
        End Select
...
'
    ...
    If Not (Populating Or Game.EnforceHistory) And IsNumeric(txtExperience(Index).Text) Then
        Select Case Index
            Case xpUnspent
                Fera.Experience.Unspent = CSng(txtExperience(xpUnspent))
            Case xpEarned
                Fera.Experience.Earned = CSng(txtExperience(xpEarned))
        End Select
    End If
...
'
    ...
    Select Case Index
        Case miBiography
            If Fera.Biography <> txtMemo(miBiography).Text Then
                SetDataChanged
                Fera.Biography = TrimWhiteSpace(txtMemo(miBiography))
            End If
        Case miNotes
            If Fera.Notes <> txtMemo(miNotes).Text Then
                SetDataChanged
                Fera.Notes = TrimWhiteSpace(txtMemo(miNotes))
            End If
    End Select
...
'
    ...
    Populating = True
    txtExperience(xpUnspent).Text = CStr(Fera.Experience.Unspent)
    txtExperience(xpEarned).Text = CStr(Fera.Experience.Earned)
    ...
    CharSheetEngine.RefreshXP lvwHistory, Fera.Experience
...
'
    ...
    If Not Populating Then
        ...
        Select Case Index
            ...
            Case xiPack
                Fera.Pack = Trim(txtUserField(Index))
            Case xiID
                Fera.ID = Trim(txtUserField(Index))
            Case xiStartDate
                If IsDate(txtUserField(Index)) Then Fera.StartDate = CDate(txtUserField(Index))
        End Select
...
'
    ...
    Select Case Index
        Case niNotoriety
            Fera.Notoriety = updNumber(niNotoriety).Value
    End Select
    SetDataChanged
...
'
    ...
    If Not Populating Then
        ...
        If IsNumeric(txtPerm(Index).Text) Then
            ...
            Select Case Index
                Case diHonor
                    Fera.Honor = CInt(FixVal)
                Case diGlory
                    Fera.Glory = CInt(FixVal)
                Case diWisdom
                    Fera.Wisdom = CInt(FixVal)
            End Select
...
'
    ...
    If Not Populating Then
        ...
        If IsNumeric(txtTemp(Index).Text) Then
            ...
            Select Case Index
                Case diHonor
                    Fera.TempHonor = Val(txtTemp(diHonor))
                Case diGlory
                    Fera.TempGlory = Val(txtTemp(diGlory))
                Case diWisdom
                    Fera.TempWisdom = Val(txtTemp(diWisdom))
            End Select
            mdiMain.AnnounceChanges Me, atTempers
            SetDataChanged
