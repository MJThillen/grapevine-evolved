...
Begin VB.Form frmActionList 
   ...
   Begin VB.Frame fraRight 
      ...
      Begin VB.CommandButton cmdAddNew 
         Caption         =   "&Add New grapevine.model.Action"
         Height          =   375
         Left            =   0
         TabIndex        =   8
         Top             =   3720
      ...
      Begin VB.CommandButton cmdShow 
         Caption         =   "&Show grapevine.model.Action"
         Default         =   -1  'True
         Height          =   375
         Left            =   0
         TabIndex        =   7
      ...
      Begin VB.CommandButton cmdDelete 
         Caption         =   "&Delete grapevine.model.Action"
         Height          =   375
         Left            =   0
         TabIndex        =   9
         Top             =   4200
...
'
    ...
    If CategoryDate Then
        ...
        Do Until grapevine.model.Game.Calendar.Off
            lstCategory.AddItem Format(grapevine.model.Game.Calendar.GetGameDate, "mmmm d, yyyy")
            If SelGame Then
                If SelDate = grapevine.model.Game.Calendar.GetGameDate Then
...
'
    ...
    If Not lstCategory.Text = "" Then
        If CategoryDate Then
            grapevine.model.Game.APREngine.MoveToFirstDate ActionList, CDate(lstCategory.Text)
        Else
            grapevine.model.Game.APREngine.MoveToFirstTitle ActionList, lstCategory.Text
        End If
        With OutputEngine
            ...
            Do Until ActionList.Off
                ...
                If CategoryDate Then
                    grapevine.model.Game.APREngine.MoveToNextDate ActionList, CDate(lstCategory.Text)
                Else
                    grapevine.model.Game.APREngine.MoveToNextTitle ActionList, lstCategory.Text
                End If
            Loop
            .grapevine.util.Template = tnMasterAction
            .GameDate = 0
        End With
    End If
...
'
    ...
    If lstCategory.ListIndex > -1 Then
        ...
        If NewName <> "" Then
            ...
            grapevine.model.Game.APREngine.InsertSorted ActionList, NewAction
...
'
    ...
    If Not (lvwActions.SelectedItem Is Nothing) And lstCategory.ListIndex > -1 Then
        ...
        grapevine.model.Game.APREngine.MoveToPair ActionList, DelDate, DelName
        ...
        If Not ActionList.Off Then
            ...
            If Not Answer Then Answer = (MsgBox("This will PERMANENTLY remove this action" & _
                    ...
                    vbYesNo + vbQuestion, "Delete grapevine.model.Action") = vbYes)
            If Answer Then
...
'
    ...
    If CategoryDate Then
        ...
        DelDate = CDate(lstCategory.Text)
        grapevine.model.Game.APREngine.MoveToFirstDate ActionList, DelDate
    Else
        DelName = lstCategory.Text
        grapevine.model.Game.APREngine.MoveToFirstTitle ActionList, DelName
    End If
...
'
    ...
    If Not lstCategory.Text = "" Then
        If CategoryDate Then
            ...
            grapevine.model.Game.APREngine.MoveToFirstDate ActionList, SelDate
            ...
            Do Until ActionList.Off
                ...
                grapevine.model.Game.APREngine.MoveToNextDate ActionList, SelDate
            Loop
        ...
        Else
            ...
            grapevine.model.Game.APREngine.MoveToFirstTitle ActionList, SelName
            ...
            Do Until ActionList.Off
                ...
                grapevine.model.Game.APREngine.MoveToNextTitle ActionList, SelName
            Loop
