...
Begin VB.Form frmOutputRumors 
   ...
   Caption         =   "Print or Export grapevine.model.Action / Plot / Rumor Reports"
   ClientHeight    =   6915
   ClientLeft      =   210
   ClientTop       =   570
   ClientWidth     =   8910
...
'
    ...
    grapevine.model.Game.APREngine.OutputMasterReport OutputAid, CurrDate, (chkActions.Value = vbChecked), _
...
'
    ...
    grapevine.model.Game.APREngine.PrepareRumorOutput CurrDate
    ...
    Do Until CharacterList.Off
        ...
        If SelSet.Has(CharacterList.Item.Name) Then
            ...
            If Not Skip Then
                ...
                grapevine.model.Game.APREngine.OutputCharacterReport OutputAid, CharacterList.Item.Name, CurrDate, _
