...
Begin VB.Form frmMummySheet 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Mummy Character"
   ClientHeight    =   6165
   ClientLeft      =   210
   ClientTop       =   405
   ClientWidth     =   9060
   Icon            =   "frmMummySheet.frx":0000
   LinkTopic       =   "Form1"
   LockControls    =   -1  'True
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   ...
   Begin VB.Frame fraTab 
      ...
      Begin VB.CommandButton cmdEstimate 
         Height          =   315
         Left            =   2535
         Picture         =   "frmMummySheet.frx":058A
         Style           =   1  'Graphical
         TabIndex        =   109
         Top             =   1470
         Width           =   585
   ...
   Begin VB.Frame fraTab 
      ...
      Begin VB.ListBox lstTraits 
         Height          =   1035
         Index           =   18
         ItemData        =   "frmMummySheet.frx":0B14
         Left            =   3360
         List            =   "frmMummySheet.frx":0B16
         TabIndex        =   93
         Tag             =   "?LO"
         Top             =   480
         Width           =   3135
      ...
      Begin VB.ListBox lstTraits 
         Height          =   2400
         Index           =   17
         ItemData        =   "frmMummySheet.frx":0B18
         Left            =   120
         List            =   "frmMummySheet.frx":0B1A
         TabIndex        =   95
         Tag             =   "?EQ"
         Top             =   2160
         Width           =   2055
   ...
   Begin VB.Frame fraTab 
      ...
      Begin VB.ListBox lstTraits 
         Height          =   1425
         Index           =   11
         ItemData        =   "frmMummySheet.frx":0B1C
         Left            =   4440
         List            =   "frmMummySheet.frx":0B1E
         TabIndex        =   88
         Tag             =   "Health Levels"
         Top             =   3120
         Width           =   2055
      ...
      Begin VB.ListBox lstTraits 
         Height          =   1425
         Index           =   10
         ItemData        =   "frmMummySheet.frx":0B20
         Left            =   2280
         List            =   "frmMummySheet.frx":0B22
         TabIndex        =   86
         Tag             =   "Status"
         Top             =   3120
         Width           =   2055
      ...
      Begin VB.ListBox lstTraits 
         Height          =   1425
         Index           =   9
         ItemData        =   "frmMummySheet.frx":0B24
         Left            =   120
         List            =   "frmMummySheet.frx":0B26
         TabIndex        =   84
         Tag             =   "Humanity"
         Top             =   3120
         Width           =   2055
      ...
      Begin VB.ListBox lstTraits 
         Height          =   2010
         Index           =   14
         ItemData        =   "frmMummySheet.frx":0B28
         Left            =   4440
         List            =   "frmMummySheet.frx":0B2A
         TabIndex        =   82
         Tag             =   "Hekau, Rituals"
         Top             =   480
         Width           =   2055
      ...
      Begin VB.ListBox lstTraits 
         Height          =   2010
         Index           =   13
         ItemData        =   "frmMummySheet.frx":0B2C
         Left            =   2280
         List            =   "frmMummySheet.frx":0B2E
         TabIndex        =   80
         Tag             =   "Hekau, Spells"
         Top             =   480
         Width           =   2055
      ...
      Begin VB.ListBox lstTraits 
         Height          =   2010
         Index           =   12
         ItemData        =   "frmMummySheet.frx":0B30
         Left            =   120
         List            =   "frmMummySheet.frx":0B32
         TabIndex        =   78
         Tag             =   "Hekau"
         Top             =   480
         Width           =   2055
   ...
   Begin VB.Frame fraTab 
      ...
      Begin VB.ListBox lstTraits 
         Height          =   1425
         Index           =   15
         ItemData        =   "frmMummySheet.frx":0B34
         Left            =   120
         List            =   "frmMummySheet.frx":0B36
         TabIndex        =   73
         Tag             =   "Merits"
         Top             =   3120
         Width           =   3135
      ...
      Begin VB.ListBox lstTraits 
         Height          =   1425
         Index           =   16
         ItemData        =   "frmMummySheet.frx":0B38
         Left            =   3360
         List            =   "frmMummySheet.frx":0B3A
         TabIndex        =   75
         Tag             =   "Flaws"
         Top             =   3120
         Width           =   3135
      ...
      Begin VB.ListBox lstTraits 
         Height          =   2010
         Index           =   7
         ItemData        =   "frmMummySheet.frx":0B3C
         Left            =   2280
         List            =   "frmMummySheet.frx":0B3E
         TabIndex        =   69
         Tag             =   "Backgrounds"
         Top             =   480
         Width           =   2055
      ...
      Begin VB.ListBox lstTraits 
         Height          =   2010
         Index           =   6
         ItemData        =   "frmMummySheet.frx":0B40
         Left            =   120
         List            =   "frmMummySheet.frx":0B42
         TabIndex        =   67
         Tag             =   "Abilities"
         Top             =   480
         Width           =   2055
      ...
      Begin VB.ListBox lstTraits 
         Height          =   2010
         Index           =   8
         ItemData        =   "frmMummySheet.frx":0B44
         Left            =   4440
         List            =   "frmMummySheet.frx":0B46
         TabIndex        =   71
         Tag             =   "Influences"
         Top             =   480
         Width           =   2055
   ...
   Begin VB.Frame fraTab 
      ...
      Begin VB.ListBox lstTraits 
         Height          =   2010
         Index           =   0
         ItemData        =   "frmMummySheet.frx":0B48
         Left            =   120
         List            =   "frmMummySheet.frx":0B4A
         TabIndex        =   54
         Tag             =   "Physical"
         Top             =   480
         Width           =   2055
      ...
      Begin VB.ListBox lstTraits 
         Height          =   2010
         Index           =   1
         ItemData        =   "frmMummySheet.frx":0B4C
         Left            =   2280
         List            =   "frmMummySheet.frx":0B4E
         TabIndex        =   56
         Tag             =   "Social"
         Top             =   480
         Width           =   2055
      ...
      Begin VB.ListBox lstTraits 
         Height          =   2010
         Index           =   2
         ItemData        =   "frmMummySheet.frx":0B50
         Left            =   4440
         List            =   "frmMummySheet.frx":0B52
         TabIndex        =   58
         Tag             =   "Mental"
         Top             =   480
         Width           =   2055
      ...
      Begin VB.ListBox lstTraits 
         Height          =   1425
         Index           =   3
         ItemData        =   "frmMummySheet.frx":0B54
         Left            =   120
         List            =   "frmMummySheet.frx":0B56
         TabIndex        =   60
      ...
      Begin VB.ListBox lstTraits 
         Height          =   1425
         Index           =   4
         ItemData        =   "frmMummySheet.frx":0B58
         Left            =   2280
         List            =   "frmMummySheet.frx":0B5A
         TabIndex        =   62
         Tag             =   "Social, Negative"
         Top             =   3120
         Width           =   2055
      ...
      Begin VB.ListBox lstTraits 
         Height          =   1425
         Index           =   5
         ItemData        =   "frmMummySheet.frx":0B5C
         Left            =   4440
         List            =   "frmMummySheet.frx":0B5E
         TabIndex        =   64
         Tag             =   "Mental, Negative"
         Top             =   3120
         Width           =   2055
   ...
   Begin VB.ListBox lstMenu 
      Height          =   2010
      ItemData        =   "frmMummySheet.frx":0B60
      Left            =   120
      List            =   "frmMummySheet.frx":0B62
      TabIndex        =   2
      Top             =   1200
      Width           =   1695
   End
   ...
   Begin MSComctlLib.TabStrip tabTabStrip 
      ...
      BeginProperty Tabs {1EFB6598-857C-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Tab4 {1EFB659A-857C-11D1-B16A-00C0F0283628} 
            Caption         =   "Hekau Hum Stat HL"
            ImageVarType    =   2
         EndProperty
         BeginProperty Tab5 {1EFB659A-857C-11D1-B16A-00C0F0283628} 
            Caption         =   "Inh Loc Eqp Bio Note"
            ImageVarType    =   2
         EndProperty
   ...
   Begin VB.Image imgIcon 
      Height          =   480
      Left            =   480
      Picture         =   "frmMummySheet.frx":0B64
      Top             =   185
      Width           =   480
   End
   ...
   End
End
Attribute VB_Name = "frmMummySheet"
...
Private Const piBa = 0
Private Const piKa = 1
Private Const piMemory = 2
Private Const piIntegrity = 3
Private Const piJoy = 4
Private Const piWillpower = 5
Private Const piBalance = 6
Private Const piSekhem = 7
...
Private Const tiHumanity = 9
Private Const tiStatus = 10
Private Const tiHealth = 11
Private Const tiHekau = 12
Private Const tiSpells = 13
Private Const tiRituals = 14
Private Const tiMerits = 15
Private Const tiFlaws = 16
Private Const tiEquipment = 17
Private Const tiLocations = 18
...
Private Mummy As MummyClass 'The Mummy character
...
Public Sub ShowMummy(Character As MummyClass)
'
' Name:         ShowMummy
' Description:  Show and initialize a new instance of the form.
' Arguments:    The MummyClass whose data the form modifies.
'
    ...
    txtUserField(xiName) = Mummy.Name
    Me.Caption = Mummy.Name

    lblField(fiAmenti) = Mummy.Amenti
    lblField(fiNature) = Mummy.Nature
    lblField(fiDemeanor) = Mummy.Demeanor
    lblField(fiStatus) = Mummy.Status
    lblField(fiPlayer) = Mummy.Player
    lblField(fiNarrator) = Mummy.Narrator
        
    lblTraitMax(tiPhysical) = "Max " & CStr(Mummy.PhysicalMax)
    lblTraitMax(tiSocial) = "Max " & CStr(Mummy.SocialMax)
    lblTraitMax(tiMental) = "Max " & CStr(Mummy.MentalMax)
    
    Call ChangeTemper(piBa, 0)
    Call ChangeTemper(piKa, 0)
    Call ChangeTemper(piMemory, 0)
    Call ChangeTemper(piIntegrity, 0)
    Call ChangeTemper(piJoy, 0)
    
    Call ChangeTemper(piWillpower, 0)
    Call ChangeTemper(piBalance, 0)
    Call ChangeTemper(piSekhem, 0)
    
    txtUserField(xiID) = Mummy.ID
    txtUserField(xiStartDate) = Format(Mummy.StartDate, "mmmm d, yyyy")
    
    txtMemo(miInheritance) = Mummy.Inheritance
    txtMemo(miBiography) = Mummy.Biography
    txtMemo(miNotes) = Mummy.Notes
    
    CharSheetEngine.RefreshTraitList lstTraits(tiPhysical), Mummy.PhysicalList
    CharSheetEngine.RefreshTraitList lstTraits(tiSocial), Mummy.SocialList
    CharSheetEngine.RefreshTraitList lstTraits(tiMental), Mummy.MentalList
    CharSheetEngine.RefreshTraitList lstTraits(tiPhysicalNeg), Mummy.PhysicalNegList
    CharSheetEngine.RefreshTraitList lstTraits(tiSocialNeg), Mummy.SocialNegList
    CharSheetEngine.RefreshTraitList lstTraits(tiMentalNeg), Mummy.MentalNegList
    CharSheetEngine.RefreshTraitList lstTraits(tiAbilities), Mummy.AbilityList
    CharSheetEngine.RefreshTraitList lstTraits(tiBackgrounds), Mummy.BackgroundList
    CharSheetEngine.RefreshTraitList lstTraits(tiInfluences), Mummy.InfluenceList
    CharSheetEngine.RefreshTraitList lstTraits(tiHumanity), Mummy.HumanityList
    CharSheetEngine.RefreshTraitList lstTraits(tiStatus), Mummy.StatusList
    CharSheetEngine.RefreshTraitList lstTraits(tiHealth), Mummy.HealthList
    
    CharSheetEngine.RefreshTraitList lstTraits(tiHekau), Mummy.HekauList
    CharSheetEngine.RefreshTraitList lstTraits(tiSpells), Mummy.SpellList
    CharSheetEngine.RefreshTraitList lstTraits(tiRituals), Mummy.RitualList
    CharSheetEngine.RefreshTraitList lstTraits(tiMerits), Mummy.MeritList
    CharSheetEngine.RefreshTraitList lstTraits(tiFlaws), Mummy.FlawList
    CharSheetEngine.RefreshTraitList lstTraits(tiEquipment), Mummy.EquipmentList
    CharSheetEngine.RefreshTraitList lstTraits(tiLocations), Mummy.HangoutList
    
    lblModified.Caption = Format(Mummy.LastModified, "mmmm d, yyyy")
    chkNPC.Value = IIf(Mummy.IsNPC, vbChecked, vbUnchecked)
...
'
    With OutputEngine
        ...
        .SelectSet(osCharacters).Add Mummy.Name
        .GameDate = 0
    End With
...
'
    ...
    If Not Populating Then
        Mummy.IsNPC = (chkNPC.Value = vbChecked)
...
'
    ...
    If lstMenu.ListIndex <> -1 Then
        ...
        If CharSheetEngine.TargetType = ttXPHistory Then
            If CharSheetEngine.AddXPEntry(lvwHistory, Mummy.Experience) Then
                RefreshXP
                SetDataChanged
                lvwHistory.SetFocus
            End If
...
'
    frmCalculator.ShowCalculator Mummy
...
'
    ...
    If CharSheetEngine.TargetType = ttXPHistory Then
        If CharSheetEngine.EditXPEntry(lvwHistory, Mummy.Experience) Then
            RefreshXP
            SetDataChanged
            lvwHistory.SetFocus
        End If
...
'
    ...
    If CharSheetEngine.TargetType = ttXPHistory Then
        If CharSheetEngine.RemoveXPEntry(lvwHistory, Mummy.Experience) Then
            RefreshXP
            SetDataChanged
            lvwHistory.SetFocus
        End If
...
'
    ...
    If TargetIndex = tiPhysical Or Game.LinkTraitMaxes Then
        Mummy.PhysicalMax = Mummy.PhysicalMax + IIf(Index = 1, 1, -1)
        lblTraitMax(tiPhysical).Caption = "Max " & Mummy.PhysicalMax
    End If
    
    If TargetIndex = tiSocial Or Game.LinkTraitMaxes Then
        Mummy.SocialMax = Mummy.SocialMax + IIf(Index = 1, 1, -1)
        lblTraitMax(tiSocial).Caption = "Max " & Mummy.SocialMax
    End If
    
    If TargetIndex = tiMental Or Game.LinkTraitMaxes Then
        Mummy.MentalMax = Mummy.MentalMax + IIf(Index = 1, 1, -1)
        lblTraitMax(tiMental).Caption = "Max " & Mummy.MentalMax
    End If
...
'
    ...
    lblModified.Caption = Format(Mummy.LastModified, "mmmm d, yyyy")
    lblShowXP = " " & CStr(Mummy.Experience.Unspent) & _
            " / " & CStr(Mummy.Experience.Earned)

    CharSheetEngine.RefreshTraitList lstTraits(tiEquipment), Mummy.EquipmentList
    CharSheetEngine.RefreshTraitList lstTraits(tiLocations), Mummy.HangoutList
    lblField(fiPlayer).Caption = Mummy.Player
    lblField(fiNarrator).Caption = Mummy.Narrator
...
'               when ShowMummy is the means of loading the form.  Initializes the
'               MenuStack linked list and the Mummy Menus.
'

    If Mummy Is Nothing Then
        MsgBox "Character sheet loaded improperly!"
    Else
                
        Set CharSheetEngine = New CharacterSheetEngineClass
        
        CharSheetEngine.RegisterSheet "Mummy", lstMenu, lblMenuItem, lblMenuTitle
    
        CharSheetEngine.RegisterTraitList tiPhysical, Mummy.PhysicalList
        CharSheetEngine.RegisterTraitList tiSocial, Mummy.SocialList
        CharSheetEngine.RegisterTraitList tiMental, Mummy.MentalList
        CharSheetEngine.RegisterTraitList tiPhysicalNeg, Mummy.PhysicalNegList
        CharSheetEngine.RegisterTraitList tiSocialNeg, Mummy.SocialNegList
        CharSheetEngine.RegisterTraitList tiMentalNeg, Mummy.MentalNegList
        CharSheetEngine.RegisterTraitList tiAbilities, Mummy.AbilityList
        CharSheetEngine.RegisterTraitList tiHumanity, Mummy.HumanityList
        CharSheetEngine.RegisterTraitList tiInfluences, Mummy.InfluenceList
        CharSheetEngine.RegisterTraitList tiStatus, Mummy.StatusList
        CharSheetEngine.RegisterTraitList tiHealth, Mummy.HealthList
        CharSheetEngine.RegisterTraitList tiBackgrounds, Mummy.BackgroundList
        
        CharSheetEngine.RegisterTraitList tiHekau, Mummy.HekauList
        CharSheetEngine.RegisterTraitList tiSpells, Mummy.SpellList
        CharSheetEngine.RegisterTraitList tiRituals, Mummy.RitualList
        CharSheetEngine.RegisterTraitList tiMerits, Mummy.MeritList
        CharSheetEngine.RegisterTraitList tiFlaws, Mummy.FlawList
        CharSheetEngine.RegisterTraitList tiEquipment, Mummy.EquipmentList
        CharSheetEngine.RegisterTraitList tiLocations, Mummy.HangoutList
...
'
    ...
    If Not lblTemperFloat.Visible Or Not lblTemperFloat.Tag = CStr(Index) Then
        ...
        Select Case Index
            Case piWillpower:   lblTemperFloat = " " & CStr(Mummy.TempWillpower) & " "
            Case piBalance:     lblTemperFloat = " " & CStr(Mummy.TempBalance) & " "
            Case piSekhem:      lblTemperFloat = " " & CStr(Mummy.TempSekhem) & " "
            Case piBa:          lblTemperFloat = " " & CStr(Mummy.TempBa) & " "
            Case piKa:          lblTemperFloat = " " & CStr(Mummy.TempKa) & " "
            Case piMemory:      lblTemperFloat = " " & CStr(Mummy.TempMemory) & " "
            Case piIntegrity:   lblTemperFloat = " " & CStr(Mummy.TempIntegrity) & " "
            Case piJoy:         lblTemperFloat = " " & CStr(Mummy.TempJoy) & " "
        End Select
...
'
    ...
    If Not (Populating Or Game.EnforceHistory) And IsNumeric(txtExperience(Index).Text) Then
        Select Case Index
            Case xpUnspent
                Mummy.Experience.Unspent = CSng(txtExperience(xpUnspent))
            Case xpEarned
                Mummy.Experience.Earned = CSng(txtExperience(xpEarned))
        End Select
    End If
...
'
    ...
    Select Case Index
        Case miInheritance
            If Mummy.Inheritance <> txtMemo(miInheritance).Text Then
                SetDataChanged
                Mummy.Inheritance = TrimWhiteSpace(txtMemo(miInheritance))
            End If
        Case miBiography
            If Mummy.Biography <> txtMemo(miBiography).Text Then
                SetDataChanged
                Mummy.Biography = TrimWhiteSpace(txtMemo(miBiography))
            End If
        Case miNotes
            If Mummy.Notes <> txtMemo(miNotes).Text Then
                SetDataChanged
                Mummy.Notes = TrimWhiteSpace(txtMemo(miNotes))
            End If
    End Select
...
'
    ...
    Populating = True
    txtExperience(xpUnspent).Text = CStr(Mummy.Experience.Unspent)
    txtExperience(xpEarned).Text = CStr(Mummy.Experience.Earned)
    ...
    CharSheetEngine.RefreshXP lvwHistory, Mummy.Experience
...
'
    ...
    If Not Populating Then
        ...
        Select Case Index
            ...
            Case xiID
                Mummy.ID = Trim(txtUserField(Index))
            Case xiStartDate
                If IsDate(txtUserField(Index)) Then Mummy.StartDate = CDate(txtUserField(Index))
        End Select
    ...
    With Mummy
        Select Case Index
            Case piWillpower
                ...
                Perm = .Willpower
            Case piBalance
                .TempBalance = .TempBalance + Change
                If Both Then .Balance = .Balance + Change
                If .TempBalance < 0 Then .TempBalance = 0
                If .Balance < 0 Then .Balance = 0
                Temp = .TempBalance
                Perm = .Balance
            Case piSekhem
                .TempSekhem = .TempSekhem + Change
                If Both Then .Sekhem = .Sekhem + Change
                If .TempSekhem < 0 Then .TempSekhem = 0
                If .Sekhem < 0 Then .Sekhem = 0
                Temp = .TempSekhem
                Perm = .Sekhem
            Case piBa
                .TempBa = .TempBa + Change
                If Both Then .Ba = .Ba + Change
                If .TempBa < 0 Then .TempBa = 0
                If .Ba < 0 Then .Ba = 0
                Temp = .TempBa
                Perm = .Ba
            Case piKa
                .TempKa = .TempKa + Change
                If Both Then .Ka = .Ka + Change
                If .TempKa < 0 Then .TempKa = 0
                If .Ka < 0 Then .Ka = 0
                Temp = .TempKa
                Perm = .Ka
            Case piMemory
                .TempMemory = .TempMemory + Change
                If Both Then .Memory = .Memory + Change
                If .TempMemory < 0 Then .TempMemory = 0
                If .Memory < 0 Then .Memory = 0
                Temp = .TempMemory
                Perm = .Memory
            Case piIntegrity
                .TempIntegrity = .TempIntegrity + Change
                If Both Then .Integrity = .Integrity + Change
                If .TempIntegrity < 0 Then .TempIntegrity = 0
                If .Integrity < 0 Then .Integrity = 0
                Temp = .TempIntegrity
                Perm = .Integrity
            Case piJoy
                .TempJoy = .TempJoy + Change
                If Both Then .Joy = .Joy + Change
                If .TempJoy < 0 Then .TempJoy = 0
                If .Joy < 0 Then .Joy = 0
                Temp = .TempJoy
                Perm = .Joy
        End Select
